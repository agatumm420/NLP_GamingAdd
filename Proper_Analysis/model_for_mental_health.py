...
class Category:
    low_score = '7-10 points'
    medium_score = '11-15 points'
    high_score = '16-26 points'


train_y = []

for item in df['GAD_score'][10:]:
    if item <= 10:
...
def test_phrase(index):
    test_x = [df['NLP_1'][df.index[index]]]
    print(f'Real score is {df["GAD_score"][df.index[index]]}')
